...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Reached out to Jay and he offered to come out to me the very same day. Arrived bang on time and got to work. Can't fault the service, highly recommended and would definitely use again if I ever have a similar job that needs doing!",
    name: "Daniel",
  },
