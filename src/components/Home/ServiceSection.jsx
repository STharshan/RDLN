...
const services = [
  {
    title: "EGR",
    desc: `Reduces NOx emissions by reusing exhaust gases.
  ...
  {
    title: "Diagnostics",
    desc: `Process of identifying and troubleshooting vehicle or system issues.
`,
    image: "/carpaint.avif",
  ...
  {
    title: "DPF",
    desc: `Filters soot from diesel engine exhaust.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[65%] mt-15 mx-auto h-55 object-top"
                    onError={(e) => {
